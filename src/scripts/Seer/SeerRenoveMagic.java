...
/*@Script.Manifest(
        ...
        */
public class SeerRenoveMagic extends PollingScript<ClientContext> implements PaintListener {
    ...
    public void poll() {
        ...
        if(ctx.skills.level(Constants.SKILLS_MAGIC)>=55){
            ...
            Point inventario=new Point(Random.nextInt(751,761),Random.nextInt(387,395));
            ctx.input.move(inventario);
